...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener, GoogleMap.OnMarkerDragListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    LatLng location = new LatLng(27.15866856, 81.97632535);
        ...
        for(int i=0; i<arrayList.size(); i++){
            ...
            mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
                ...
                public void onMapClick(@NonNull LatLng latLng) {
                    //Starting Services
                    Intent i = new Intent(MapsActivity.this, MyLocationApp.class);
                    startService(i);
                }
            });
        }
